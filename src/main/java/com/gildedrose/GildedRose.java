                ...
                if (!items[i].name.equals("Aged Brie")) { //"Aged Brie" actually increases in Quality the older it gets
                    if (!items[i].name.equals("Backstage passes to a TAFKAL80ETC concert")) {
                        if (items[i].quality > 0) {//The Quality of an item is never negative
                            if (!items[i].name.equals("Sulfuras, Hand of Ragnaros") && !items[i].name.equals("Sulfuras New")) { //"Sulfuras", being a legendary item, never has to be sold or decreases in Quality
                                items[i].quality = items[i].quality - 1;
                            }
                        }
                    } else {
